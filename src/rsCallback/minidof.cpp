...
/**********************************************************
	public functions
 **********************************************************/
void MiniDof::setCallbackParams(rsSim::ModularRobot *robot, rsSim::BodyList &bodies, rsSim::ConnectorList &conn, bool units) {
	_bodies = bodies;
	_conn = conn;
	_robot = dynamic_cast<rsSim::MiniDof *>(robot);
	_units = units;
}

void MiniDof::operator()(osg::Node *node, osg::NodeVisitor *nv) {
