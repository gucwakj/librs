...
MiniDof::MiniDof(short joint) : Robot(rs::MiniDof) {
	// enabled joint
	_enabled = joint;
...
/**********************************************************
	public functions
 **********************************************************/
const rs::Pos MiniDof::getConnFacePosition(short type, short side, short orientation, const rs::Pos &p, const rs::Quat &q) {
	// new position
	rs::Pos P(p);
...
const rs::Quat MiniDof::getConnFaceQuaternion(short type, short side, short orientation, const rs::Quat &q) {
	// new quaternion
	rs::Quat Q(q);
...
const rs::Pos MiniDof::getConnBodyPosition(short type, short orientation, const rs::Pos &p, const rs::Quat &q) {
	// new position
	rs::Pos P(p);
...
const rs::Quat MiniDof::getConnBodyQuaternion(short type, short orientation, const rs::Quat &q) {
	// new quaternion
	rs::Quat Q(q);
...
const rs::Quat MiniDof::getRobotBodyQuaternion(short body, float theta, const rs::Quat &q) {
	// new quaternion
	rs::Quat Q(q);
...
const rs::Pos MiniDof::getRobotCenterPosition(short face, const rs::Pos &p, const rs::Quat &q) {
	// new position
	rs::Pos P(p);
...
const rs::Quat MiniDof::getRobotCenterQuaternion(short face, short orientation, float angle, const rs::Quat &q) {
	// new quaternion
	rs::Quat Q(q);
...
const rs::Pos MiniDof::getRobotFacePosition(short face, const rs::Pos &p, const rs::Quat &q) {
	// new position
	rs::Pos P(p);
