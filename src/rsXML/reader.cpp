...
void Reader::read_sim(tinyxml2::XMLDocument *doc, bool process) {
	...
	while (node) {
		if (node->ToComment()) {}
			...
			_robot[third]->addConnector(new Conn(0, 0, -1, 3, 3, _robot[first]->getID(), 1, rsLinkbot::Connectors::Simple));
			_robot[third]->addConnector(new Conn(0, 0, rsLinkbot::Connectors::SmallWheel, 3, 3, _robot[first]->getID(), 2, rsLinkbot::Connectors::Simple));
			_robot[fourth]->addConnector(new Conn(0, 0, -1, 3, 3, _robot[second]->getID(), 1, rsLinkbot::Connectors::Simple));
			_robot[fourth]->addConnector(new Conn(0, 0, rsLinkbot::Connectors::SmallWheel, 3, 3, _robot[second]->getID(), 2, rsLinkbot::Connectors::Simple));
			if ( (ele = node->FirstChildElement("led")) ) {
				a = 0; b = 0; c = 0; d = 0;
				ele->QueryDoubleAttribute("r", &a);
				ele->QueryDoubleAttribute("g", &b);
			...
			_robot[second]->addConnector(new Conn(0, 0, -1, 1, 1, _robot[second]->getID(), 1, rsLinkbot::Connectors::Simple));
			_robot[second]->addConnector(new Conn(0, 0, rsLinkbot::Connectors::SmallWheel, 1, 1, _robot[second]->getID(), 2, rsLinkbot::Connectors::Simple));
			_robot[second]->addConnector(new Conn(0, 0, -1, 3, 3, _robot[first]->getID(), 1, rsLinkbot::Connectors::Simple));
			_robot[second]->addConnector(new Conn(0, 0, rsLinkbot::Connectors::SmallWheel, 3, 3, _robot[first]->getID(), 2, rsLinkbot::Connectors::Simple));
			if ( (ele = node->FirstChildElement("led")) ) {
				a = 0; b = 0; c = 0; d = 0;
				ele->QueryDoubleAttribute("r", &a);
				ele->QueryDoubleAttribute("g", &b);
			...
			_robot[third]->addConnector(new Conn(0, rs::Left, -1, 1, 1, _robot[third]->getID(), 1, rsLinkbot::Connectors::Bridge));
			_robot[fourth]->addConnector(new Conn(0, rs::Left, -1, 1, 1, _robot[third]->getID(), 2, rsLinkbot::Connectors::Bridge));
			_robot[third]->addConnector(new Conn(0, 0, -1, 2, 2, _robot[third]->getID(), 1, rsLinkbot::Connectors::Simple));
			_robot[third]->addConnector(new Conn(0, 0, rsLinkbot::Connectors::Faceplate, 2, 2, _robot[third]->getID(), 2, rsLinkbot::Connectors::Simple));
			_robot[fourth]->addConnector(new Conn(0, 0, -1, 2, 2, _robot[fourth]->getID(), 1, rsLinkbot::Connectors::Simple));
			_robot[fourth]->addConnector(new Conn(0, 0, rsLinkbot::Connectors::Faceplate, 2, 2, _robot[fourth]->getID(), 2, rsLinkbot::Connectors::Simple));
			if ( (ele = node->FirstChildElement("led")) ) {
				a = 0; b = 0; c = 0; d = 0;
				ele->QueryDoubleAttribute("r", &a);
				ele->QueryDoubleAttribute("g", &b);
			...
			_robot[fifth]->setID(i + 4);
			_robot[first]->addConnector(new Conn(0, rs::Left, -1, 1, 1, _robot[first]->getID(), 1, rsLinkbot::Connectors::Bridge));
			_robot[first]->addConnector(new Conn(0, rs::Right, -1, 2, 2, _robot[first]->getID(), 1, rsLinkbot::Connectors::Simple));
			_robot[first]->addConnector(new Conn(0, rs::Right, rsLinkbot::Connectors::Caster, 2, 2, _robot[first]->getID(), 2, rsLinkbot::Connectors::Simple));
			_robot[first]->addConnector(new Conn(0, rs::Right, -1, 3, 3, _robot[first]->getID(), 1, rsLinkbot::Connectors::Bridge));
			_robot[second]->addConnector(new Conn(0, rs::Left, -1, 1, 1, _robot[first]->getID(), 2, rsLinkbot::Connectors::Bridge));
			_robot[second]->addConnector(new Conn(0, rs::Right, -1, 3, 3, _robot[first]->getID(), 2, rsLinkbot::Connectors::Bridge));
			_robot[second]->addConnector(new Conn(0, rs::Left, -1, 2, 2, _robot[second]->getID(), 1, rsLinkbot::Connectors::Simple));
			...
			_robot[fourth]->addConnector(new Conn(0, rs::Left, -1, 1, 1, _robot[third]->getID(), 2, rsLinkbot::Connectors::Bridge));
			_robot[fourth]->addConnector(new Conn(0, rs::Right, -1, 3, 3, _robot[third]->getID(), 2, rsLinkbot::Connectors::Bridge));
			_robot[fourth]->addConnector(new Conn(0, rs::Left, -1, 2, 2, _robot[fourth]->getID(), 1, rsLinkbot::Connectors::Simple));
			_robot[fifth]->addConnector(new Conn(0, rs::Left, -1, 2, 2, _robot[fourth]->getID(), 2, rsLinkbot::Connectors::Simple));
			_robot[fifth]->addConnector(new Conn(0, rs::Up, -1, 1, 1, _robot[fifth]->getID(), 1, rsLinkbot::Connectors::Simple));
			_robot[fifth]->addConnector(new Conn(0, rs::Up, rsLinkbot::Connectors::Gripper, 1, 1, _robot[fifth]->getID(), 2, rsLinkbot::Connectors::Simple));
			_robot[fifth]->addConnector(new Conn(0, rs::Right, -1, 3, 3, _robot[fifth]->getID(), 1, rsLinkbot::Connectors::Simple));
			_robot[fifth]->addConnector(new Conn(0, rs::Right, rsLinkbot::Connectors::Gripper, 3, 3, _robot[fifth]->getID(), 2, rsLinkbot::Connectors::Simple));
			if ( (ele = node->FirstChildElement("led")) ) {
				a = 0; b = 0; c = 0; d = 0;
