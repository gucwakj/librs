...
void Reader::read_graphics(tinyxml2::XMLDocument *doc) {
	...
	// loop over all nodes
	while (node) {
		if ( !strcmp(node->Value(), "arc") ) {
			// create object
			_marker.push_back(new Marker(rs::Arc));
			// id
			i = 0;
		...
		else if ( !strcmp(node->Value(), "arcsector") ) {
			// create object
			_marker.push_back(new Marker(rs::ArcSector));
			// id
			i = 0;
			node->QueryIntAttribute("id", &i);
			_marker.back()->setID(i);
		...
		else if ( !strcmp(node->Value(), "arcsegment") ) {
			// create object
			_marker.push_back(new Marker(rs::ArcSegment));
			// id
			i = 0;
			node->QueryIntAttribute("id", &i);
			_marker.back()->setID(i);
		...
		else if ( !strcmp(node->Value(), "arrow") ) {
			// create object
			_marker.push_back(new Marker(rs::Arrow));
			// id
			i = 0;
			node->QueryIntAttribute("id", &i);
			_marker.back()->setID(i);
		...
		else if ( !strcmp(node->Value(), "circle") ) {
			// create object
		...
		if ( !strcmp(node->Value(), "quad") ) {
			...
			// create object
			_marker.push_back(new Marker(rs::Star));
			// id
			i = 0;
			node->QueryIntAttribute("id", &i);
			_marker.back()->setID(i);
